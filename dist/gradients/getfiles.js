...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, json, gradients, fileText;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                json = _a.sent();
                gradients = JSON.stringify(json);
                fileText = "export const uiGradients = " + gradients + ";";
                // Cause is only runned when run in dist, makes a .js file
                fs_1.writeFileSync(path_1.join(__dirname, 'uigradients-gradients.js'), fileText);
                return [2 /*return*/];
        }
    });
}); };
